...
test_set_filename = '../Testing/data/test/twitter-dev-gold-B.tsv'
...
def run_global_gridsearch(classifications):
    ...
    for c in classifications:
        ...
        g1 = cache1[m1name] if m1name in cache1 else run_gridsearch(m1, docs_train_subjectivity, y_train_subjectivity,
                                                                    extra=e1)
