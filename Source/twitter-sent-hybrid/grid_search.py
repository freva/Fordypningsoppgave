...
def grid_search(clf, feature_pipeline, docs_train, y_train):
    ...
    parameters = {
        ...
        'features__char_ngrams__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.naive_negation_attachment)],
        'features__word_clusters__preprocessors': [(p.html_decode, p.dummy), (p.html_decode, p.reduce_letter_duplicates), (p.html_decode, p.hash_as_normal)],
        'features__word_clusters__norm': [True, False],
        'features__lexicon__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.naive_negation_attachment, p.strip_tweet),
                                             (p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.naive_negation_attachment, p.strip_tweet),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.naive_negation_attachment),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.strip_tweet),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.naive_negation_attachment, p.strip_tweet),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.quote_placeholder, p.naive_negation_attachment, p.strip_tweet)],
        'features__lexicon__norm': [True, False],
        'features__pos_tagger__norm': [True, False],
