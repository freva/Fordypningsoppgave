...
def grid_search(clf, feature_pipeline, docs_train, y_train):
    ...
    parameters = {
        ...
        'features__char_ngrams__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.limit_chars, p.split_into_contexts_naive),
        ...
        'features__lexicon__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.limit_chars),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.limit_chars)],
        ...
        'features__pos_tagger__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_rt_tag, p.split),
                                                (p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_rt_tag, p.limit_chars)],
