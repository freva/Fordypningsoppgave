...
def grid_search(clf, feature_pipeline, docs_train, y_train):
    ...
    parameters = {
        ...
        'features__word_vectorizer__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_emoticons, p.no_rt_tag),
                                                     (p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_emoticons, p.no_rt_tag, p.lower_case)],
        ...
        'features__char_ngrams__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.limit_chars, p.split_into_contexts_naive2),
                                                 (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.lower_case, p.reduce_letter_duplicates, p.limit_chars, p.split_into_contexts_naive2)],
        'features__word_clusters__preprocessors': [(p.html_decode, p.hash_as_normal, p.lower_case, p.reduce_letter_duplicates)],
        ...
        'features__pos_tagger__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_rt_tag, p.lower_case, p.split)],
