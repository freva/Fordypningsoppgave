...
def grid_search(clf, feature_pipeline, docs_train, y_train):
    ...
    parameters = {
        ...
        'features__char_ngrams__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.naive_negation_attachment),
                                                 ...
                                                 (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.split_into_contexts_naive),
        ...
        'features__lexicon__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.naive_negation_attachment),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.split_into_contexts_naive),
                                             (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.split)],
        'features__lexicon__norm': [True],
        'features__pos_tagger__norm': [True],
        'features__pos_tagger__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.strip_tweet),
                                                (p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_rt_tag, p.strip_tweet),
                                                (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.strip_tweet),
                                                (p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.split)],
