...
def grid_search(clf, feature_pipeline, docs_train, y_train):
    ...
    parameters = {
        ...
        'features__word_vectorizer__min_df': [0, 10, 50, 100],
        'features__word_vectorizer__max_df': [0.45, 0.50, 0.55],
        ...
        'features__char_ngrams__min_df': [0, 10, 50, 100],
        'features__char_ngrams__max_df': [0.45, 0.5, 0.55],
