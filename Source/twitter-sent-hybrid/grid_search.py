...
def grid_search(clf, feature_pipeline, docs_train, y_train):
    ...
    parameters = {
        ...
        'features__word_vectorizer__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.no_hash, p.no_emoticons, p.no_rt_tag, p.naive_negation_attachment),
        ...
        'features__char_ngrams__preprocessors': [(p.html_decode, p.no_url, p.no_username, p.hash_as_normal, p.no_rt_tag, p.reduce_letter_duplicates, p.quote_placeholder, p.naive_negation_attachment),
        ...
        'features__emoticons__preprocessors': [(p.html_decode, p.dummy), (p.html_decode, p.no_url)],
